...
public class PaymentController {
  ...
  public ResponseEntity<?> addPayment(@PathVariable("paymentOrder") UUID paymentOrder,
  ...
  public ResponseEntity<?> findPaymentOrdersByPurchaseOrderId(@PathVariable("purchaseOrderId") UUID purchaseOrderId) {
    return new ResponseEntity(paymentService.findPaymentOrderCompleteByPurchaseOrderId(purchaseOrderId), HttpStatus.OK);
  }
}
